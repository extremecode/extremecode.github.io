...
plt.show()
```
<img src="./images/backprop23.png" alt="data" class="inline"/>

### Forward function and utilites  
```markdown
...
plt.show()
```
<img src="./images/backprop24.png" alt="data" class="inline"/>
